...
interface TemplateAreaProps {
  ...
  onHeroTextChange: (
    heroText: { header: string; subHeader: string; bodyText: string },
    itemId: string
  ) => void;
  onBannerTextChange: (
      ...
      case "GRID":
        component = (
          <GridComponent
            ...
            onHeroTextChange={(text: {
              header: string;
              subHeader: string;
              bodyText: string;
            }) => onHeroTextChange(text, item.id)}
            onBannerTextChange={(text: {
              header: string;
              subHeader: string;
              bodyText: string;
            }) => onBannerTextChange(text, item.id)}
          />
        );
        break;
      case "PAGE":
