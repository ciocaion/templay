...
const Sidebar: React.FC<SidebarProps> = ({ onOpenTutorial, onSave, onRetrieve, onDelete, onPreview, isBuilderPage }) => {
        ...
        {isBuilderPage && (
          <>
            <Flex align="center" onClick={onSave} cursor="pointer">
              <Text style={textStyle} fontSize="md">Save Template</Text>
            </Flex>
            <Flex align="center" onClick={onRetrieve} cursor="pointer">
              <Text style={textStyle} fontSize="md">Retrieve Template</Text>
            </Flex>
            <Flex align="center" onClick={onDelete} cursor="pointer">
              <Text style={textStyle} fontSize="md">Delete Template</Text>
            </Flex>
            <Flex align="center" onClick={onPreview} cursor="pointer">
              <Text style={textStyle} fontSize="md">Preview Template</Text>
            </Flex>
          </>
        )}
      </VStack>
